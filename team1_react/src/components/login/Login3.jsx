...
export default function Login3() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fdf8ec] bg-[url('/textures/paper-texture.png')] bg-repeat bg-cover">
      {/* 로그인 박스 */}
      <div className="relative bg-white shadow-lg rounded-lg p-8 w-96">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2
                ...
                rotate-[2deg] skew-x-[1deg] border border-white/20">
          MEMBER LOGIN
        </div>
